...
class isweepGUI:
    ...
    def toggleDm(self):
        if self.darkmode.get() == 0:
            ...
            self.bStyle.configure(style='my.TButton', font=('Helvetica', 15), background='black', foreground='royalblue')

            
            self.bStyle.configure(style='my.TButton', font=('Helvetica', 12), background='black', foreground='royalblue')

            
            self.lStyle.configure(style='my.TLabel', font=('Helvetica', 12), background='black', foreground='royalblue')

           
            self.stylecb.configure(style='my.TCheckbutton', font=('Helvetica', 12), background='black', foreground='royalblue')
