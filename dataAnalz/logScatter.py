...
def logScatter(fileName: str, marker: str = None, markerSize: str = None, color: str = None, label: str = None):
    ...
    plt.scatter(voltage, current, marker=marker, color=color, s=markerSize, label = label)
    plt.semilogy()