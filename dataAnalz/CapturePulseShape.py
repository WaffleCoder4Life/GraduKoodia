...
settings = {
            ...
            "biasVoltage" : "23_3V", # Use same voltage for measurements. Biasvoltage = breakdownVoltage + 2.5 V, V_bd to be determined beforehand.
            ...
            # File settings
            "pathNameDate" : "11062024", # Run morningCoffee.py first and then change todays date for correct file path
            "pathNameDate2" : "10042024",
            "fileName" : "197OhmPtPlatePulseShapeAveg",
            "temperature" : "197 $\\Omega$",
            "fileName2" : "1_169kOhmTempPulseShapeAveg",
            "temperature2" : "1.17 k$\\Omega$",
            "testDescribtion" : "Pulse shapes at 197 Ohm (pt plate) for different amount of photoelectrons, overvoltage 23_3V",
            ...
            "compare1PE" : 0, #Compare single PE pulses from different files. Change pathNameDate, pathNameDate2 and file names accordingly
            "closeAfter" : 1
